...
class BendaharaController extends Controller
{
    ...
    public function indextagihan()
    {
        $tagihan = DB::table('tagihan')
            ...
            ->join('petugas', 'petugas.id', '=', 'pembayaran.petugas_id')
            ...
            ->select('tagihan.*', 'pembayaran.status as pembayaran_status', 'petugas_user.name as petugas_name', 'wajib_retribusi_user.name as wajib_retribusi_name', 'pembayaran.*', 'kontrak.*', 'item_retribusi.*', 'sub_wilayah.*')
