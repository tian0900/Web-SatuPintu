    ...
    <div class="sidebar close">
        ...
        <ul class="sidebar-list">
            ...
            <li class="dropdown">
              <div class="title">
                  <a href="#" class="link">
                      ...
                      <span class="name">Item Retribusi</span>
                  </a>
                  <i class='bx bxs-chevron-down'></i>
              </div>
              <div class="submenu">
                  <a href="/atribut" class="link ">Atribut</a>
                  <a href="/atributsampah" class="link">Atribut sampah</a>
              </div>
          </li>
            ...
            <li>
                ...
                <div class="submenu">
                    <a href="/logout" class="link submenu-title">Settings</a>
                    <!-- submenu links here  -->
                </div>
            </li>
        </ul>
