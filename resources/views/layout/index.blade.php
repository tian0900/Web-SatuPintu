...
<head>
  ...
  <style>
      ...
      .modal {
          ...
          height: 100%;
          overflow: auto;
          /* Memungkinkan scrolling jika konten terlalu panjang */
          background-color: rgba(0, 0, 0, 0.4);
          /* Efek gelap latar belakang */
          padding-top: 60px;
          /* Membuat jarak dari bagian atas */
      }

      .modal-content {
          background-color: #fefefe;
          margin: 5% auto;
          /* Memposisikan modal ke tengah layar */
          padding: 20px;
...
<body>
    <div class="antialiased ">
        <nav class=" border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        ...
        <!-- Sidebar -->
        <aside class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidenav" id="drawer-navigation">
