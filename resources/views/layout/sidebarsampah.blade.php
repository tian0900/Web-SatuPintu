...
<body>
    ...
    <div class="sidebar close">
        ...
        <ul class="sidebar-list">
            ...
            <li>
                ...
                <div class="submenu">
                    <a href="/kontraksampah" class="link submenu-title">Kontrak</a>
                    <!-- submenu links here  -->
                </div>
            </li>
    ...
    <section class="home p-4">
        <div class="toggle-sidebar">
            ...
            <nav
                class="border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 left-0 right-0 top-0 z-50">
