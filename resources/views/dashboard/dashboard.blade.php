            ...
            <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 mb-3">
                    <div class="content col-span-2">
                        ...
                        <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Kerja bagus, Sistem Anda siap digunakan! Anda dapat melihat Kabupaten, Kedinasan, Retribusi dan mengunduh laporan menggunakan Sistem ini.</p>
