        ...
        <section class="bg-white dark:bg-gray-900">
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 mb-3">
                            <div class="content col-span-2">
                                <h5 class="mb-2 text-3xl font-bold text-utama ">Welcome Back {{ Auth::user()->name }} <i
                                        class='bx bx-party text-hitam'></i></h5>
                                <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Kerja bagus, Sistem
                                    Anda siap digunakan! Anda dapat melihat Kedinasan dan mengunduh laporan menggunakan
                                    Sistem ini.</p>
            ...
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-3 ">
                ...
                <div class="sm:grid-cols-1">
                    <a href="#"
                        class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 max-w-md mx-auto">
                        ...
                        <p class="text-2xl text-gray-900 dark:text-white">{{ $kedinasan }}</p>
                    </a>
                </div>
                <div>
                    <a href="#"
                        ...
                        <p class="text-2xl text-gray-900 dark:text-white">{{ $retribusi }}</p>
                    </a>
                </div>
