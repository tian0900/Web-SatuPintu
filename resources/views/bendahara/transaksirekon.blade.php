...
@section('content')
    <div class="container p-5">
        <h1 class="mt-3 text-4xl tracking-tight pb-3">Rekonsiliasi</h1>
                            ...
                            <tbody>
                                ...
                                @foreach ($tagihan as $item)
                                    <tr class="table-row">
                                        ...
                                        <td class="px-3 py-3">
                                            <a href="{{ route('tagihan-wilayah', ['sub_wilayah_id' => $item->sub_wilayah_id]) }}" class="text-blue-500 hover:underline">Detail</a>
                                        </td>
