                                ...
                                @foreach ($setor as $item)
                                    ...
                                    <div id="modalkonfirmasi{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="relative w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                                                    <h3 class="text-xl font-medium text-gray-900 dark:text-white">Konfirmasi Setoran</h3>
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                ...
                                                <div class="p-4">
                                                    <p>Apakah anda yakin untuk mengonfirmasi setoran ini?</p>
                                                </div>
                                                <div class="flex justify-end p-4 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                                    {{-- <form action="{{ route('bendahara.setor.konfirmasi', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <button type="submit" class="btn btn-success">Ya</button>
                                                    </form> --}}
                                                    <button data-modal-hide="modalkonfirmasi{{ $item->id }}" type="button" class="btn btn-secondary">Tidak</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
