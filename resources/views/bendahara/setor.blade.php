            ...
            <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                ...
                <div class="flex space-x-4 mb-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="dropdownRadio" class="hidden">
                            <ul class="py-1">
                                <li><a href="#" data-filter="all" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200">Show All</a></li>
                                <li><a href="#" data-filter="day" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200">Last Day</a></li>
                                <li><a href="#" data-filter="week" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200">Last Week</a></li>
                                <li><a href="#" data-filter="month" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200">Last Month</a></li>
                                <li><a href="#" data-filter="year" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200">Last Year</a></li>
                            </ul>
                        </div>
