...
@php
    // Ambil nama sub_wilayah dari item pertama
    $subWilayahNama = $tagihan->first()->sub_wilayah_nama;
@endphp

<!-- ============= Home Section =============== -->
@section('content')
    <div class="container p-5">
        <h1 class="mt-3 text-4xl tracking-tight">Daftar {{ $subWilayahNama }}</h1>
        ...
        <div class="container mt-3">
            ...
            <div class="container">
                <div
                    ...
                    <div class="mx-2">
                        ...
                        <div class="relative inline-block text-left">
                            <button id="dropdownRadioButton" data-dropdown-toggle="dropdownRadio"
                                ...
                                {{-- <span id="dropdownLabel">{{ $filterLabel }}</span> --}}
                            ...
                            <div id="dropdownRadio" class="hidden z-10 w-44 bg-white rounded shadow dark:bg-gray-800">
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li><a href="?filter=day"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Last
                                            Day</a></li>
                                    <li><a href="?filter=week"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Last
                                            Week</a></li>
                                    <li><a href="?filter=month"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Last
                                            Month</a></li>
                                    <li><a href="?filter=year"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Last
                                            Year</a></li>
                                    <li><a href="?filter=all"
                    ...
                    <!-- Search Form -->
                    <form action="{{ route('tagihan.search') }}" method="GET" class="mb-4">
