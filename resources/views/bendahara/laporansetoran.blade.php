                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                <label for="kelompok_pasar"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelompok Pasar</label>
                    ...
                    <div class="relative">
                        ...
                        <div id="dropdownRadio" class="hidden z-10 w-48 bg-white rounded-lg shadow dark:bg-gray-700">
                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                                <li>
                                    <a href="{{ url('lapsetoran?filter=day') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Day</a>
                                </li>
                                <li>
                                    <a href="{{ url('lapsetoran?filter=week') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Week</a>
                                </li>
                                <li>
                                    <a href="{{ url('lapsetoran?filter=month') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Month</a>
                                </li>
                                <li>
                                    <a href="{{ url('lapsetoran?filter=year') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Year</a>
                                </li>
                                <li>
                                    <a href="{{ url('lapsetoran?filter=all') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">All</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="relative">
                    ...
                    <form method="GET" action="{{ route('lapsetoran') }}" class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="table-search" name="search" value="{{ request()->query('search') }}" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items">
                        </div>
                    </form>
