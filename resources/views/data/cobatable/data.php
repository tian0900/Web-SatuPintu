                ...
                <form class="p-4 md:p-5" action="{{ route('item.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="Username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Retribusi</label>
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="Identifier" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kategori Nama</label>
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="Last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga</label>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                        <!-- Modal toggle -->
                        <a data-modal-target="modal<?= $data->id ?>" data-modal-toggle="modal<?= $item->id ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline text-center">Edit</a>
                        </td>
                    </tr>
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4">
                                    <form action="{{ route('item.update', $item->id) }}" method="POST">
                                        ...
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            <div class="col-span-2">
                                                <label for="retribusi_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Retribusi</label>
                                                <input type="number" id="retribusi_id" name="retribusi_id" value="{{ old('retribusi_id', $item->retribusi_id)}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="">
                                            </div>
                                        </div>
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="kategori_nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">kategori_nama</label>
                                            <input type="text" id="kategori_nama" name="kategori_nama" value="{{ old('kategori_nama', $item->kategori_nama)}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="">
                                        </div>
                                        </div>
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="F-Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Tagihan</label>
                                            <input type="text" id="jenis_tagihan" name="jenis_tagihan" value="{{ old('jenis_tagihan', $item->jenis_tagihan)}}" class="bg-gray-50 bordeFirst Namer border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="">
                                        </div>
                                        </div>
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            <div class="col-span-2">
                                                <label for="editHarga" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga</label>
                                                <input type="text" id="harga" name="harga" value="{{ old('harga', $item->harga)}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="">
                                            </div>
                                        </div>
                                        <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <svg class="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg>
