        ...
        @if (auth()->user()->admin->retribusi_id &&
            ...
            <div class="container">
                <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                    ...
                    <div class="search">
                        <form method="GET" action="{{ route('atribut') }}" class="mb-4">
    ...
    <div id="addDataModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form action="{{ route('dinamis.store') }}" method="POST" class="p-6 ">
                    @csrf
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md dark:bg-gray-800">
                ...
                <form action="{{ route('dataa.store') }}" method="POST" class="space-y-4" id="dynamic-form">
                    ...
                    <!-- Tambahkan field harga secara langsung -->
                    <div class="flex space-x-4 mb-4">
                        <input type="text" name="dynamicField[harga]" placeholder="Harga"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5" action="{{ route('atribut.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="F-Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No
                                Unit</label>
