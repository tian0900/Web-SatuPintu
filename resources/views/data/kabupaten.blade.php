...
@section('content')
    <div class="container p-5">
        <h1 class="mt-3 text-5xl">Daftar Kabupaten</h1>
        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form class="p-4 md:p-5" action="{{ route('kabupaten.store') }}" method="POST">
                        @csrf
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <nav class="bg-white flex items-center flex-column flex-wrap md:flex-row justify-between p-4"
                        ...
                        <span
                            ...
                            Showing
                            <span class="font-semibold text-gray-900 dark:text-white">{{ $kabupaten->firstItem() }}</span>
                            to
                            <span class="font-semibold text-gray-900 dark:text-white">{{ $kabupaten->lastItem() }}</span>
                            of
