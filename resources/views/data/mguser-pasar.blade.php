            ...
            <div>
                ...
                <div id="dropdownRadio" class="hidden z-10 w-48 bg-white rounded shadow dark:bg-gray-700">
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                        <li><a href="?filter=day" class="block px-4 py-2 filter-link" data-label="Last Day">Last Day</a>
                        </li>
                        <li><a href="?filter=week" class="block px-4 py-2 filter-link" data-label="Last Week">Last
                                Week</a></li>
                        <li><a href="?filter=month" class="block px-4 py-2 filter-link" data-label="Last Month">Last
                                Month</a></li>
                        <li><a href="?filter=year" class="block px-4 py-2 filter-link" data-label="Last Year">Last
                                Year</a></li>
                    </ul>
                </div>
