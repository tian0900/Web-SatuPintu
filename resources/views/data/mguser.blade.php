        ...
        <div class="container m-5">
            ...
            <div class="table-responsive"> <!-- Responsiveness for small screens -->
                                    ...
                                    <div id="crud-user" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <!-- Modal body -->
                                                <form class="p-4 md:p-5" action="{{ route('users.store') }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                                        <div class="col-span-2">
                                    ...
                                    <div id="crud-wajib" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <!-- Modal body -->
                                                <form class="p-4 md:p-5" action="{{ route('wajib.store') }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                                        <div class="col-span-2">
                ...
                <div id="modal<?= $data->id ?>" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="bg-white rounded-lg overflow-hidden max-w-lg w-full max-h-full">
                        <!-- Modal header -->
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                    ...
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="retribusi_id"
                                                ...
                                                Id</label>
                                            <input type="text" id="retribusi_id" name="retribusi_id"
                                                value="{{ old('retribusi_id', $data->name) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                required="">
                                        </div>
                                    </div>
