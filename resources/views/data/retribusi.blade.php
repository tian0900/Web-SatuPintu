...
@section('content')
    <div class="container p-5">
        <h1 class="mt-3 text-4xl tracking-tight">Daftar Retribusi</h1>
        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form class="p-4 md:p-5" action="{{ route('retribusi.store') }}" method="POST">
                        @csrf
...
<div id="dropdownRadio" class="hidden z-10 w-48 bg-white rounded shadow dark:bg-gray-700">
    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
        <li><a href="?filter=day" class="block px-4 py-2 filter-link" data-label="Last Day">Last Day</a></li>
        <li><a href="?filter=week" class="block px-4 py-2 filter-link" data-label="Last Week">Last Week</a></li>
        <li><a href="?filter=month" class="block px-4 py-2 filter-link" data-label="Last Month">Last Month</a></li>
        <li><a href="?filter=year" class="block px-4 py-2 filter-link" data-label="Last Year">Last Year</a></li>
    </ul>
</div>
                                ...
                                <div id="modal<?= $data->id ?>" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <!-- Modal body -->
                                            <div class="p-4">
                                                <form action="{{ route('retribusi.update', $data->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                                        <div class="col-span-2">
                    ...
                    <nav class="bg-white flex items-center flex-column flex-wrap md:flex-row justify-between p-4" aria-label="Table navigation">
                        ...
                        <div class="w-full md:w-auto text-right">
                            <ul class="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
                                ...
                                @else
                                    <li>
                                        <a href="{{ $retribusi->previousPageUrl() }}" class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" aria-label="Previous">Previous</a>
                                    </li>
                                @endif
                    
                                <!-- Pagination Elements -->
                                @foreach ($retribusi->links()->elements[0] as $page => $url)
                                    @if ($page == $retribusi->currentPage())
                                ...
                                <!-- Next Page Link -->
                                @if ($retribusi->hasMorePages())
                                    <li>
                                        <a href="{{ $retribusi->nextPageUrl() }}" class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" aria-label="Next">Next</a>
                                    </li>
                                @else
