...
@section('content')
    <div class="container p-5">
        <h1 class="mt-3 text-4xl tracking-tight">Daftar Kedinasan</h1>
        <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
            ...
            <div class="relative">
                <form method="GET" action="{{ route('kedinasann') }}">
                    <div class="relative">
                        <div
        ...
        <div class="container m-5">
            <div class="container">
                ...
                <div class="table-responsive mt-4"> <!-- Responsiveness for small screens -->
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3">Kepala Dinas</th>
                            ...
                            <tbody>
                                @php
                                    $number = ($kedinasan->currentPage() - 1) * $kedinasan->perPage() + 1;
                                ...
                                @foreach ($kedinasan as $item)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">{{ $item->kepala_dinas }}</td>
                                        <td class="px-6 py-4">{{ $item->kabupaten->nama }}</td>
                                        <td class="px-6 py-4">
                                            <!-- Modal toggle -->
                                            ...
                                            <a data-modal-target="delete-modal{{ $item->id }}"
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <form class="p-4 md:p-5"
                                                    action="{{ route('kedinasan.update', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                                        <div class="col-span-2">
                                                        ...
                                                        <div class="col-span-2">
                                                            ...
                                                            <select id="kabupaten_id" name="kabupaten_id"
                                                                ...
                                                                @foreach ($kabupaten as $kab)
                                                                    <option value="{{ $kab->id }}"
                                                                        {{ $item->kabupaten_id == $kab->id ? 'selected' : '' }}>
                                                                        {{ $kab->nama }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5">
                                                    <p class="text-sm text-gray-900 dark:text-gray-400">Apakah Anda yakin ingin menghapus data kedinasan
                                                        <strong>{{ $item->nama }}</strong>?</p>
                                                </div>
                                                <!-- Modal footer -->
                                                <div class="flex items-center justify-end p-4 md:p-5 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                                    <button type="button" data-modal-toggle="delete-modal{{ $item->id }}"
                                                    ...
                                                    <form action="{{ route('kedinasan.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                    ...
                                    <!-- Include modal code here as in your original code -->
                                @endforeach
                            </tbody>
                        </table>
                        <nav class="bg-white flex items-center flex-column flex-wrap md:flex-row justify-between p-4"
                            ...
                            <span
                                ...
                                Showing
                                <span
                                    class="font-semibold text-gray-900 dark:text-white">{{ $kedinasan->firstItem() }}</span>
                                to
                                <span
                                    class="font-semibold text-gray-900 dark:text-white">{{ $kedinasan->lastItem() }}</span>
                                of
