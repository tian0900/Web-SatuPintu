                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input type="text" id="kategori_nama" name="kategori_nama"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Kategori Nama" required="">
                            </div>
                        </div>
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 text-center ">
                                                <form action="{{ route('item.delete', $data->id) }}" method="POST">
                                                    @csrf
                                                    @method('Delete')
                                                    ...
                                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                        Apakah Anda yakin ingin menghapus Item ini?</h3>
                                                    <button type="submit"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4">
                                                <form action="{{ route('item.update', $data->id) }}" method="POST">
                                                    ...
                                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                                        <div class="col-span-2">
                                                            <label for="jenis_tagihan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                                Jenis Tagihan
                                                            </label>
                                                            <select id="jenis_tagihan" name="jenis_tagihan"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                required="">
                                                                <option value="HARIAN" {{ old('jenis_tagihan', $data->jenis_tagihan) == 'HARIAN' ? 'selected' : '' }}>HARIAN</option>
                                                                <option value="MINGGUAN" {{ old('jenis_tagihan', $data->jenis_tagihan) == 'MINGGUAN' ? 'selected' : '' }}>MINGGUAN</option>
                                                                <option value="BULANAN" {{ old('jenis_tagihan', $data->jenis_tagihan) == 'BULANAN' ? 'selected' : '' }}>BULANAN</option>
                                                            </select>
                                                        </div>
                                                    </div>
